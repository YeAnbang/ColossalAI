...
from llama_rope_utils import LlamaConfig
# from llama_rope_utils_colo import LlamaForCausalLM, LlamaConfig
...
def train(args):
    ...
    dataset = load_mixed_cont_pretrain_dataset_from_config(args.cont_pretrain_dataset_config)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cont_pretrain_dataset_config", type=str, default=None)
    parser.add_argument(
    ...
    parser.add_argument("--scaling_factor", type=int, default=1.0)
    ...
    parser.add_argument("--max_number_of_checkpoints", type=int, default=3, help="number checkpoints to keep")
