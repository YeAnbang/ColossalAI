...
from coati.trainer.base import SLTrainer
from coati.trainer.utils import is_rank_0, to_device
...
class SFTTrainer(SLTrainer):
    ...
    def _train(self, epoch: int):
        ...
        for i, batch in enumerate(self.train_dataloader):
            ...
            if self.model.unwrap().memory is not None:
                self.model.unwrap().memory.reset()
